...
def filter_data(data):
    ...
    """
    bonds = data[data["amount_outstanding"] >= 100_000]
    ...
    mask_ratio_par = bonds['price_eom'] / bonds['principal_amt']

    return bonds[mask_g1 & mask_l10 & mask_ratio_par].set_index("date")
